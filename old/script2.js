...
function setError(elem, message) {
    ...
    // Add an additional class to the password field's form-control
    const passwordFormControl = document.querySelector('#password').parentElement;
    passwordFormControl.className += ' password-error';
  }
